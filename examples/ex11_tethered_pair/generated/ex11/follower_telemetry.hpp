...
void capture_follower_telemetry(const FollowerCraft& craft, double t_sec, FollowerCraftTelemetry& telem);

inline std::string FollowerCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_follower_telemetry(const FollowerCraft& craft, double t_sec, FollowerCraftTelemetry& telem) {
    telem.t_sec = t_sec;
