# AUTOGENERATED by manta-codegen for world 'ex11'.

set(manta_ex11_DIR ${CMAKE_CURRENT_LIST_DIR})

set(manta_ex11_SOURCES
    ${manta_ex11_DIR}/leader.cpp
    ${manta_ex11_DIR}/follower.cpp
    ${manta_ex11_DIR}/ex11_main.cpp
)

set(manta_ex11_HEADERS
    ${manta_ex11_DIR}/leader.hpp
    ${manta_ex11_DIR}/follower.hpp
    ${manta_ex11_DIR}/ex11_config.h
)

set(manta_ex11_CONFIG_INCLUDE "-include${manta_ex11_DIR}/ex11_config.h")
...
function(manta_ex11_apply target)
    target_include_directories(${target} PRIVATE ${manta_ex11_DIR})
    target_compile_options(${target} PRIVATE "SHELL:-include ${manta_ex11_DIR}/ex11_config.h")
endfunction()
...
add_executable(ex11 ${manta_ex11_SOURCES})
target_link_libraries(ex11 PRIVATE manta::manta zenohcxx::zenohc)
manta_ex11_apply(ex11)
