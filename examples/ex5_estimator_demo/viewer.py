...
Subscribes to both 'manta/ex5/state' (truth) and 'manta/ex5/estimate' (EKF
...
Usage:
    ...
    python examples/ex5_estimator_demo/viewer.py
"""
...
def main() -> None:
    ...
    print("ex5 viewer: subscribed to manta/ex5/state and manta/ex5/estimate. "
          "Ctrl-C to exit.")
    signal.pause()
