"""ex5 — Phase-4 EKF demo: sim + estimator side-by-side, in one process.
...
in ex5.cpp wires the EKF and Zenoh I/O.

Codegen:

    PYTHONPATH=python/manta_codegen/src \\
        python -m manta_codegen.cli examples/ex5_estimator_demo/craft.py \\
            --workflow library
"""
...
def make_world() -> World:
    ...
    # the user main via Zenoh ('manta/ex5/thrust/cmd').
