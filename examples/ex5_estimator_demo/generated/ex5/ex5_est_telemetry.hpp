...
void capture_ex5_est_telemetry(const Ex5EstCraft& craft, double t_sec, Ex5EstCraftTelemetry& telem);

inline std::string Ex5EstCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex5_est_telemetry(const Ex5EstCraft& craft, double t_sec, Ex5EstCraftTelemetry& telem) {
    telem.t_sec = t_sec;
