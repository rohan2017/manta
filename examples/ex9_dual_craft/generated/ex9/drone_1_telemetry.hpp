...
void capture_drone_1_telemetry(const Drone1Craft& craft, double t_sec, Drone1CraftTelemetry& telem);

inline std::string Drone1CraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_drone_1_telemetry(const Drone1Craft& craft, double t_sec, Drone1CraftTelemetry& telem) {
    telem.t_sec = t_sec;
