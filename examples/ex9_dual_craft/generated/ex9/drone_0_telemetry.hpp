...
void capture_drone_0_telemetry(const Drone0Craft& craft, double t_sec, Drone0CraftTelemetry& telem);

inline std::string Drone0CraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_drone_0_telemetry(const Drone0Craft& craft, double t_sec, Drone0CraftTelemetry& telem) {
    telem.t_sec = t_sec;
