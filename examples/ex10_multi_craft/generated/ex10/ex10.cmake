# AUTOGENERATED by manta-codegen for world 'ex10'.

set(manta_ex10_DIR ${CMAKE_CURRENT_LIST_DIR})

set(manta_ex10_SOURCES
    ${manta_ex10_DIR}/alpha.cpp
    ${manta_ex10_DIR}/beta.cpp
    ${manta_ex10_DIR}/ex10_main.cpp
)

set(manta_ex10_HEADERS
    ${manta_ex10_DIR}/alpha.hpp
    ${manta_ex10_DIR}/beta.hpp
    ${manta_ex10_DIR}/ex10_config.h
)

set(manta_ex10_CONFIG_INCLUDE "-include${manta_ex10_DIR}/ex10_config.h")
...
function(manta_ex10_apply target)
    target_include_directories(${target} PRIVATE ${manta_ex10_DIR})
    target_compile_options(${target} PRIVATE "SHELL:-include ${manta_ex10_DIR}/ex10_config.h")
endfunction()
...
add_executable(ex10 ${manta_ex10_SOURCES})
target_link_libraries(ex10 PRIVATE manta::manta zenohcxx::zenohc)
manta_ex10_apply(ex10)
