...
void capture_beta_telemetry(const BetaCraft& craft, double t_sec, BetaCraftTelemetry& telem);

inline std::string BetaCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_beta_telemetry(const BetaCraft& craft, double t_sec, BetaCraftTelemetry& telem) {
    telem.t_sec = t_sec;
