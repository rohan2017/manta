...
void capture_ex0_telemetry(const Ex0Craft& craft, double t_sec, Ex0CraftTelemetry& telem);

inline std::string Ex0CraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex0_telemetry(const Ex0Craft& craft, double t_sec, Ex0CraftTelemetry& telem) {
    telem.t_sec = t_sec;
