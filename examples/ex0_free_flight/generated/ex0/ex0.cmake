# AUTOGENERATED by manta-codegen for craft 'ex0'.

set(manta_ex0_DIR ${CMAKE_CURRENT_LIST_DIR})

set(manta_ex0_SOURCES
    ${manta_ex0_DIR}/ex0.cpp
    ${manta_ex0_DIR}/ex0_main.cpp
)

set(manta_ex0_HEADERS
    ${manta_ex0_DIR}/ex0.hpp
    ${manta_ex0_DIR}/ex0_config.h
)

set(manta_ex0_CONFIG_INCLUDE "-include${manta_ex0_DIR}/ex0_config.h")
...
function(manta_ex0_apply target)
    target_include_directories(${target} PRIVATE ${manta_ex0_DIR})
    target_compile_options(${target} PRIVATE "SHELL:-include ${manta_ex0_DIR}/ex0_config.h")
endfunction()
...
add_executable(ex0 ${manta_ex0_SOURCES})
target_link_libraries(ex0 PRIVATE manta::manta zenohcxx::zenohc)
manta_ex0_apply(ex0)
