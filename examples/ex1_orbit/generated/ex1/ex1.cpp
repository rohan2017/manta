...
void tick() {
    ...
    if (++g_pub_decim >= kPubEvery) {
        ...
        { std::string _json = "{";
          _json += "\"t\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.world().clock().time())); _json += _b; }
          _json += ",";
          _json += "\"p\":[";
          ...
          _json += ",";
          _json += "\"tx_zp\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.tx_zp().throttle())); _json += _b; }
          _json += ",";
          _json += "\"tx_zn\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.tx_zn().throttle())); _json += _b; }
          _json += ",";
          _json += "\"ty_xp\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.ty_xp().throttle())); _json += _b; }
          _json += ",";
          _json += "\"ty_xn\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.ty_xn().throttle())); _json += _b; }
          _json += ",";
          _json += "\"tz_yp\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.tz_yp().throttle())); _json += _b; }
          _json += ",";
          _json += "\"tz_yn\":";
          { char _b[32]; std::snprintf(_b, sizeof(_b), "%.17g", double(craft.tz_yn().throttle())); _json += _b; }
          _json += "}";
