...
void capture_ex9_telemetry(const Ex9Craft& craft, double t_sec, Ex9CraftTelemetry& telem);

inline std::string Ex9CraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex9_telemetry(const Ex9Craft& craft, double t_sec, Ex9CraftTelemetry& telem) {
    telem.t_sec = t_sec;
