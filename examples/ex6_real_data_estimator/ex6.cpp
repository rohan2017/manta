...
//
// The codegen-emitted Ex6EstCraftT<Scalar> is wrapped in CraftEKF<...>,
...
#include "ex6_est.hpp"          // Ex6EstCraftT<Scalar>
...
int main() {
    ...
    std::printf("ex6: subscribing to manta/ex7/imu and manta/ex7/dvl, "
