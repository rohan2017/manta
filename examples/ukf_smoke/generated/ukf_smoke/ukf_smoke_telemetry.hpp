...
void capture_ukf_smoke_telemetry(const UkfSmokeCraft& craft, double t_sec, UkfSmokeCraftTelemetry& telem);

inline std::string UkfSmokeCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ukf_smoke_telemetry(const UkfSmokeCraft& craft, double t_sec, UkfSmokeCraftTelemetry& telem) {
    telem.t_sec = t_sec;
