...
void capture_ex7_est_telemetry(const Ex7EstCraft& craft, double t_sec, Ex7EstCraftTelemetry& telem);

inline std::string Ex7EstCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex7_est_telemetry(const Ex7EstCraft& craft, double t_sec, Ex7EstCraftTelemetry& telem) {
    telem.t_sec = t_sec;
