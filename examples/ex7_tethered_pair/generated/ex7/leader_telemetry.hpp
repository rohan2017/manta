...
void capture_leader_telemetry(const LeaderCraft& craft, double t_sec, LeaderCraftTelemetry& telem);

inline std::string LeaderCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_leader_telemetry(const LeaderCraft& craft, double t_sec, LeaderCraftTelemetry& telem) {
    telem.t_sec = t_sec;
