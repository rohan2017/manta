...
void capture_ex8_est_telemetry(const Ex8EstCraft& craft, double t_sec, Ex8EstCraftTelemetry& telem);

inline std::string Ex8EstCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex8_est_telemetry(const Ex8EstCraft& craft, double t_sec, Ex8EstCraftTelemetry& telem) {
    telem.t_sec = t_sec;
