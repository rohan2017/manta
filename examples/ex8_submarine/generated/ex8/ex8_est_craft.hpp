...
public:
    Ex8EstCraftT() : manta::CraftT<Scalar>("ex8_est") {
        ...
        imu_ = &this->root().template add<manta::parts::IMUT<Scalar>>("imu", 0.05f, 0.005f, -1.0f, -1.0f, manta::MFloat(100.0));
        dvl_ = &this->root().template add<manta::parts::DVLT<Scalar>>("dvl", 0.02f, manta::MFloat(10.0));
        mag_ = &this->root().template add<manta::parts::MagnetometerT<Scalar>>("mag", 2e-07f, manta::MFloat(50.0));
