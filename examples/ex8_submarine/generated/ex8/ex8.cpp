...
void tick() {
    ...
    // connect: imu.last_accel → imu.set_measurement_accel
    {
        ...
        manta_gen::ex8_est::ekf_0.craft().imu().set_measurement_accel(manta::geom::Vec3<manta::PartFrame, double>{v0, v1, v2});
    }
    // connect: imu.last_gyro → imu.set_measurement_gyro
    {
        ...
        manta_gen::ex8_est::ekf_0.craft().imu().set_measurement_gyro(manta::geom::Vec3<manta::PartFrame, double>{v0, v1, v2});
    }
    // connect: dvl.last_velocity → dvl.set_measurement
    {
        ...
        manta_gen::ex8_est::ekf_0.craft().dvl().set_measurement(manta::geom::Vec3<manta::PartFrame, double>{v0, v1, v2});
    }
