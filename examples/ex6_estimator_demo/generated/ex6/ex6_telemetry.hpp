...
void capture_ex6_telemetry(const Ex6Craft& craft, double t_sec, Ex6CraftTelemetry& telem);

inline std::string Ex6CraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex6_telemetry(const Ex6Craft& craft, double t_sec, Ex6CraftTelemetry& telem) {
    telem.t_sec = t_sec;
