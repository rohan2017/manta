...
void capture_ex6_est_telemetry(const Ex6EstCraft& craft, double t_sec, Ex6EstCraftTelemetry& telem);

inline std::string Ex6EstCraftTelemetry::to_json() const {
    char buf[256];
    std::string s = "{";
...
inline void capture_ex6_est_telemetry(const Ex6EstCraft& craft, double t_sec, Ex6EstCraftTelemetry& telem) {
    telem.t_sec = t_sec;
