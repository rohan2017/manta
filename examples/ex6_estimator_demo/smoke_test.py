...
Usage:
    Terminal A: ./build/examples/ex6_estimator_demo
    Terminal B: python examples/ex6_estimator_demo/smoke_test.py
"""
...
def main() -> int:
    ...
    pub   = session.declare_publisher("manta/ex6/thrust/cmd")
