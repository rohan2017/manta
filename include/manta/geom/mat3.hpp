...
public:
    ...
    Mat3& operator+=(const Mat3& o) noexcept      { m_ += o.m_; return *this; }

    // Invert a linear map — reverses the From/To direction.
    Mat3<To, From, Scalar> inverse() const noexcept {
        return Mat3<To, From, Scalar>{m_.inverse()};
    }
